...
{
    /// <summary>
    /// The unique key identifier use to register with the <see cref="StatusEffectRegistry"/>.
    /// </summary>
    public class Registrant : ScriptableObject
    {
#if UNITY_EDITOR && ADDRESSABLES
        internal StatusEffectRegistryDependency OptionalRegistryDependency => m_OptionalRegistryDependency;
#endif
        ...
        [SerializeField] private StatusEffectRegistryDependency m_OptionalRegistryDependency = null;
#endif
