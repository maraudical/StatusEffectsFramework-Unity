...
namespace StatusEffects
{
    ...
    {
        public const string k_MyCustomSettingsPath = "Assets/Plugins/StatusEffectsFramework/Runtime/Settings/Resources/StatusEffectsFramework/StatusEffectSettings.asset";
        ...
        {
            var settings = Resources.Load<StatusEffectSettings>("StatusEffectsFramework/StatusEffectSettings");
#if UNITY_EDITOR
            if (settings == null)
            {
